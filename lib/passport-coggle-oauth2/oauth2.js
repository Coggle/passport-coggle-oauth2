...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://coggle.it/dialog/authorize';
  options.tokenURL = options.tokenURL || 'https://coggle.it/token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get('https://coggle.it/api/1/badge', accessToken, function (err, body, res) {
